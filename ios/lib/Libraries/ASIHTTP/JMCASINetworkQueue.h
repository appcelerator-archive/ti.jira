...
#import "JMCASIHTTPRequestDelegate.h"
#import "JMCASIProgressDelegate.h"

@interface JMCASINetworkQueue : NSOperationQueue <JMCASIProgressDelegate, JMCASIHTTPRequestDelegate, NSCopying> {
...
// All JMCASINetworkQueues are paused when created so that total size can be calculated before the queue starts
