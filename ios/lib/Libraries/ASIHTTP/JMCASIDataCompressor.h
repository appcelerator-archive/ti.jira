...
// This is a helper class used by JMCASIHTTPRequest to handle deflating (compressing) data in memory and on disk
...
@interface JMCASIDataCompressor : NSObject {
	BOOL streamReady;
	z_stream zStream;
}
