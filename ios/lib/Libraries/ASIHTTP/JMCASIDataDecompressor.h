...
// This is a helper class used by JMCASIHTTPRequest to handle inflating (decompressing) data in memory and on disk
...
@interface JMCASIDataDecompressor : NSObject {
	BOOL streamReady;
	z_stream zStream;
}
